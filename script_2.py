...
print("✅ Created QR generator and Flask server")
print("5. qr_generator.py (smart_attendance_system/src/attendance/core/qr_generator.py)")
print("6. flask_server.py (smart_attendance_system/src/attendance/core/flask_server.py)")